...
<body class="sb-nav-fixed">
	...
	<div id="layoutSidenav">
		...
		<div id="layoutSidenav_content">
			...
			<main>
				<c:url var='insertUrl' value='/adminpages/coupon/insertCoupon' />
