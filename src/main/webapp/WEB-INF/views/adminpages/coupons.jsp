...
<script>
	function deleteCoupon(ids, empno) {
		if (confirm('確定要刪除優惠卷編號為: ' + empno + ' 這筆紀錄?')) {
			let url = "<c:url value='/adminpages/coupon/CouponDelete' />" + "/"
					+ ids;
	...
	function queryCouponByKeyword(){
	    var keyword = document.getElementById('form1').value;
	    window.location.href = '/adminpages/coupon/queryCouponByKeyword?keyword=' + keyword;
	}
...
<body class="sb-nav-fixed">
	...
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
		...
		<ul class="navbar-nav ms-auto me-0 me-md-3 my-2 my-md-0">
			<li class="nav-coupon dropdown"><a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
				<font size="5"><i class="fas fa-user fa-fw"></i></font>
		</a>
				<ul class="dropdown-menu dropdown-menu-end"
					aria-labelledby="navbarDropdown">
					<li><a class="dropdown-coupon" href="#!"><font size="4">設定</font></a></li>
					<li><hr class="dropdown-divider" /></li>
					<li><a class="dropdown-coupon" href="<c:url value='/logout'/>"><font size="4">登出</font></a></li>
				</ul>
			</li>
		</ul>
	</nav>
	<div id="layoutSidenav">
		...
		<div id="layoutSidenav_content">
			...
			<div class="input-group">
				...
				<button type="button" class="btn btn-primary" onclick="queryCouponByKeyword()">
						...
						<div class="col-md-12">
							<div class="table-title">
								<div class="row">
									<div
										...
										<h2 class="ml-lg-2">優惠卷資料管理</h2>
									</div>
									<div
										class="col-sm-6 p- d-md-inline-block justify-content-lg-end justify-content-lg-end">

										<a href="<c:url value='/adminpages/coupon/CreateCouponForm' />"
								...
								<tbody>
									...
									<c:forEach var='coupon' items='${couponList}'>
										<tr>
											...
											<td>優惠卷折扣：${coupon.discount_amount}<br>優惠卷使用期間：${coupon.valid_from}到${coupon.valid_to}前有效</td>
											<td><img width='50' height='60' src='${coupon.image_id.dataUri}'></td>
											<td><a class="edit"
												href="<c:url value='/adminpages/coupon/findById/${coupon.coupon_id}' />">
													<i class="fa-sharp fa-light fa-pen" id="material-icons"></i>
											</a> <a class="delete"
												onclick="return deleteCoupon('${coupon.coupon_id}', '${coupon.discount_type}');">
							...
							<div class="clearfix">
								<div class="hint-text">
									...
									筆，共有 <b id="total">${fn:length(couponList)}</b> 筆
								</div>
								<ul class="pagination">
									<!-- 上一頁按鈕 -->
									<li class="page-coupon ${currentPage == 1 ? 'disabled' : ''}"
									...
									<c:forEach var="page" begin="1" end="${totalPages}"
										varStatus="status">
										<li class="page-coupon ${currentPage == page ? 'active' : ''}">
									...
									<!-- 下一頁按鈕 -->
									<li
										class="page-coupon ${currentPage == totalPages ? 'disabled' : ''}"
			...
			<footer class="py-4 bg-light mt-auto">
				<div class="container-fluid px-4">
					<div
						class="d-flex align-coupons-center justify-content-between small">
