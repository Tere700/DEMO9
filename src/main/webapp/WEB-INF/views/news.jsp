...
<html data-wf-page="6503f66368763805040cc875"
					...
					<div class="navigation">
						<nav role="navigation" class="nav-menu w-nav-menu">
							...
							<a href="topup.html" class="nav-link w-nav-link">點數商店</a> <a
								href="/news" aria-current="page"
								class="nav-link w-nav-link w--current">消息新聞</a>
							<div>
								<img
							...
							<div data-hover="false" data-delay="0"
								...
								<nav class="w-dropdown-list">
									<a
										href="/findEmployee.do?id=${sessionScope.myUser.id}&userId=${sessionScope.myUser.id}"
							...
							<a href="../login-register/model2.html"
								class="nav-link w-nav-link">註冊</a> <a
								href="../login-register/loginpage.html"
		...
		<section class="team-slider-c4819py-copy">
			<div class="container-10">
				<div class="w-layout-blockcontainer container-11 w-container">
					<img src="../images/LOGO.png" loading="lazy" width="161"
						sizes="(max-width: 479px) 100vw, (max-width: 767px) 30vw, 160.98959350585938px"
						alt=""
						srcset="../images/LOGO-p-500.png 500w, ../images/LOGO.png 556w"
						class="image-2">
				...
				<div data-delay="4000" data-animation="slide"
					class="team-slider-wrapper w-slider" data-autoplay="false"
							...
							<div class="team-slide-wrapper w-slide">
								<div>
									<div class="team-block">
										<img src="${member.imageUrl}" loading="lazy" alt=""
											class="team-member-image-two">
										<div class="team-block-info">
											<h3 class="team-member-name-two">${member.name}</h3>
											<p class="team-member-text">
												<a href="../account-details/news-page.html" class="link-7">${member.description}</a>
											</p>
											<a href="/news2" class="text-link-arrow w-inline-block">
					...
					<div
						class="team-slider-nav w-slider-nav w-slider-nav-invert w-round"></div>
				</div>
			</div>
		</section>
		<div class="wrapper"></div>
			...
			<div class="container">
				<div class="footer-wrapper-two">
					<a href="#" class="footer-brand-2 w-inline-block"><img
						...
						sizes="(max-width: 479px) 88vw, 252.9861297607422px" alt=""
					...
					<div class="footer-form w-form">
						<form id="wf-form-Footer-Form" name="wf-form-Footer-Form"
							...
							data-wf-page-id="6503f66368763805040cc875"
							data-wf-element-id="2f28f37e-4498-a339-8d3d-a046cad60e2b">
