...
<html data-wf-page="6503f66368763805040cc876" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
        ...
        <div class="wrapper nav-bar-wrapper">
          ...
          <div class="navigation">
            <nav role="navigation" class="nav-menu w-nav-menu">
              ...
              <a href="..//news" class="nav-link w-nav-link">消息新聞</a>
      ...
      <div class="container-31">
        <div class="testimonial-card-three">
          <div class="testimonial-card-content">
            <h3 class="testimonial-card-heading">5team解謎節已熱烈展開，整整一週歡慶各式解謎遊戲！ 從現在至 6 月 1 日上午 10 點（PT）止，來發掘折扣、試玩版，以及更多以破解謎題為主軸的遊戲內容（包括已發行及未發行遊戲）。</h3>
            <p class="testimonial-text-three">“使出最強的問題解決技巧，一邊破解密碼、找出失落環節、回歸事物原貌，一邊探索帶有解謎精神的眾多遊戲。大家熟悉且獲得極度好評的作品《世紀帝國IV》、《全軍破敵》、《CSGO》、《電馭叛客 2077：自由幻局》、《決戰時刻II》，都有機會拿到 1 折的超殺折扣，原價要 1790 元的遊戲現在只要 179 元即可入手。”</p>
            <div class="testimonial-info-four"><img src="https://i.imgur.com/UMBvdZL.jpg" loading="lazy" alt="" class="testimonial-image-3 centered">
              <div>
                <h3 class="testimonial-author-name-three">5team解謎節</h3>
                <div class="testimonial-title">Sep.28 - Nov.04</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="footer-wrapper-two">
          ...
          <div class="footer-form w-form">
            <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="6503f66368763805040cc876" data-wf-element-id="2f28f37e-4498-a339-8d3d-a046cad60e2b">
